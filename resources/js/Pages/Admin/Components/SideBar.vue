        ...
        <ul class="space-y-2">
            <li>
                ...
                <svg aria-hidden="true"
                    class="w-6 h-6 text-green-700 transition duration-75 group-hover:text-green-900"
            ...
            <li>
                <Link :href="route('admin.courts')"
                    class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg hover:bg-gray-100 group">
                    <svg class="w-6 h-6 text-green-700 gray:text-white group-hover:text-green-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
